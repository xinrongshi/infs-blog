...
import com.infs.blog.mapper.ArticleMapper;
import com.infs.blog.model.*;
import com.infs.blog.service.*;
...
public class ApplicationTests {
	...
	public void pageByAuthor(){
		Page<Article> page = articleService.pageByAuthor(1, 20, "jane");
		System.out.println(page);
	}
	...
	public void findUserByName(){
		User user = userService.findUserByName("jane");
